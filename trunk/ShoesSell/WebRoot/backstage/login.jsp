...
<script type="text/javascript">
 ...
 document.getElementById('code').src='verifyCode.jsp?t='+(new Date().getTime());
	...
	<body>
		...
		<s:form action="backlogin.action" method="post" theme="simple">
							...
							<tr>
								<td>
									<table width="100%" border="0" cellpadding="0" cellspacing="0"
										...
										<tr>
											<td align="center">
												<img src="images/logo.png" width="107" height="97" />
											</td>
										</tr>
										<tr>
					...
					<td>
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td width="30%">
									<input name="manager.managername" type="text" size="30" />
								</td>
								<td width="30%">
									<s:fielderror>
							...
							<tr>
								...
								<td>
									<input name="manager.password" type="password" size="32" />
								</td>
								<td>
									<s:fielderror>
										<s:param>manager.password</s:param>
									</s:fielderror>
								</td>
